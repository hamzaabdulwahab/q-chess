...
export const SoundControl: React.FC<SoundControlProps> = ({
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {/* Sound Control Panel */}
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 bg-gray-800 border border-gray-600 rounded-lg shadow-xl p-4 min-w-[280px] z-50">
          ...
          <button
            ...
            className="mt-4 w-full bg-gray-600 hover:bg-gray-500 text-white py-2 rounded transition-colors"
          >
            Close
          </button>
        </div>

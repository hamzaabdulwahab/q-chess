...
export function PlayerCard({
  ...
  return (
    ...
    >
      ...
      {timeLeftMs != null && (
        <div
          className="shrink-0 rounded-md px-1.5 py-1 font-mono text-sm leading-none tabular-nums sm:px-2.5 sm:py-1.5 sm:text-xl md:text-2xl"
          style={{
            ...
            minWidth: "clamp(3.7rem, 16vw, 5.25rem)",
            textAlign: "right",
            letterSpacing: 0,

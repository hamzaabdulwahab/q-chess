...
export async function initializeDatabase() {
  ...
  try {
    ...
    await connection.execute(`DROP PROCEDURE IF EXISTS CreateNewGame`);
    await connection.execute(`
    ...
    await connection.execute(`DROP PROCEDURE IF EXISTS RecordMove`);
    await connection.execute(`
    ...
    await connection.execute(`DROP PROCEDURE IF EXISTS CompleteGame`);
    await connection.execute(`
    ...
    // Create triggers
    await connection.execute(`DROP TRIGGER IF EXISTS update_game_on_move`);
    await connection.execute(`
    ...
    // Create functions
    await connection.execute(`DROP FUNCTION IF EXISTS GetPlayerStats`);
    await connection.execute(`
